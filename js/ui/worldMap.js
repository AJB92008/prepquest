...
const SUBJECT_ISLAND_ART = {
  ...
  "sat-rw": (color) => `
    <svg viewBox="0 0 140 120" width="140" height="120" aria-hidden="true">
      ...
      <path d="M36,56 L26,68 L34,74 L24,84 L38,88 L34,100 L50,92 L54,106 L64,94 L72,108 L80,92 L92,98 L86,84 L98,80 L88,70 L96,60 L82,54 Z" fill="#8a6a48" />
      <path d="M54,106 L52,116 M72,108 L75,117" fill="none" stroke="#6b4d30" stroke-width="1.5" stroke-linecap="round" opacity="0.7" />
